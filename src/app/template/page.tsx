    ...
    <div className="flex flex-row">
      <div className="basis-2/3 h-screen flex justify-center">
        ...
        <div className="flex w-full h-screen bg-green-500">
          <div className="container relative bg-blue-500 w-[500px] h-[500px]  m-auto">
            ...
            <div className="top-0 bottom-0 left-0 right-0 flex flex-col flex-1 overflow-hidden bg-transparent bg-bottom bg-cover">
              <div className="self-center flex-1 w-full max-w-xl">
                <div className="relative flex flex-col px-3 py-1 m-auto">
                  ...
                  <div className="self-center px-2 py-1 mx-0 my-1 text-sm text-white text-gray-700 bg-white border border-gray-200 rounded-full shadow rounded-tg">September 29</div>
                  ...
                  <div className="self-end w-3/4 my-2">
                    <div className="p-4 text-sm bg-lime-200 rounded-t-lg rounded-l-lg shadow text-black">
