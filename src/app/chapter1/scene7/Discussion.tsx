        ...
        <div className="flex w-full h-full">
            <div className="relative flex flex-col flex-1">
                <div className="self-center flex-1 w-full max-w-xl overflow-auto">
                    <div className="relative flex flex-col px-3 py-2 m-auto">
                        ...
                        {stage > 2 && <>
                            ...
                            <ExternalDiscussion text={scene7[7]} name="Skyler" delay={12} telegramWindow={false} />
                        </>}
                        {stage > 3 && <>
                        ...
                        {stage > 4 && <>
                            ...
                            <ExternalDiscussion text={scene7[10]} name="Skyler" delay={2} telegramWindow={false} />
                            <ExternalDiscussion text={scene7[11]} name="Skyler" delay={8} telegramWindow={false} />
                            <ExternalDiscussion text={scene7[12]} name="Skyler" delay={12} telegramWindow={false} />
                            <ExternalDiscussion text={scene7[13]} name="Skyler" delay={18} telegramWindow={false} />
                        </>}
                        {stage > 5 && <>
                            <AzadDiscussion azadText={azadText[5]} delay={0.2} duration={0.7} />
                            <ExternalDiscussion text={scene7[14]} name="Skyler" delay={2} telegramWindow={false} />
                            <ExternalDiscussion text={scene7[15]} name="Skyler" delay={5} telegramWindow={false} />
                            <ExternalDiscussion text={scene7[16]} name="Skyler" delay={10} telegramWindow={false} />
                        </>}
                        {stage > 6 && <>
                ...
                >
                    ...
                    {stage === 3 &&
                        <AzadChoices stage={stage} setStage={setStage} azadText={azadText} setAzadText={setAzadText} choices={scene7Choices[3]} delay={17} duration={.5} />
                    }
                    {stage === 4 &&
                        <AzadChoices stage={stage} setStage={setStage} azadText={azadText} setAzadText={setAzadText} choices={scene7Choices[4]} delay={10} duration={.5} />
                    }
                    {stage === 5 &&
                        <AzadChoices stage={stage} setStage={setStage} azadText={azadText} setAzadText={setAzadText} choices={scene7Choices[5]} delay={23} duration={.5} />
                    }
                    {stage === 6 &&
