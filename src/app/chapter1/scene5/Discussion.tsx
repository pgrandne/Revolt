            ...
            {stage < 4 &&
                <div className="relative flex flex-col flex-1">
                    ...
                    >
                        ...
                        {stage === 1 &&
                            <AzadChoices stage={stage} setStage={setStage} azadText={azadText} setAzadText={setAzadText} choices={scene5Choices[1]} delay={7} duration={.5} />
                        }
                        {stage === 2 &&
                            <AzadChoices stage={stage} setStage={setStage} azadText={azadText} setAzadText={setAzadText} choices={scene5Choices[2]} delay={7} duration={.5} />
                        }
                    </div>
                </div>
            }
