        ...
        <div className="bg-slate-900 bg-opacity-60 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0 z-50">
            <div className={` bg-[#0f1216] px-2 sm:px-16 py-2 sm:py-14 rounded-md text-center w-4/5`}>
                <div className="flex justify-center">
                    {deck &&
                        <p className="inline font-sans sm:block text-sm md:text-xl my-4 font-bold"><span className="font-permarker md:text-3xl">Revolte </span> {t('title')}</p>
                    }
                    {!deck &&
                        <p className="inline font-sans sm:block text-sm md:text-xl my-4 font-bold"><span className="font-permarker md:text-3xl">Revolte </span> {t('subtitle')}</p>
                    }
                </div>
                {deck &&
    ...
    return (
        <div className="bg-slate-900 bg-opacity-90 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0 z-30">
            <div className="font-permarker flex flex-col bg-[#0f1216] px-2 sm:px-16 py-2 sm:py-14 gap-2 rounded-md text-center w-2/5">
                ...
                <a className="bg-red-500 hover:bg-red-700 px-7 py-2 ml-2 rounded-md text-2xl text-white font-semibold" target="_blank" href="https://msprr0gajgn.typeform.com/to/DSl54TqJ#url=chap1scene7"
                    onClick={() => {
