            ...
            >
                <div className="text-sm text-black">
                    ...
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 318.6 318.6" className="inline h-5 mx-1 cursor-pointer animate-pulse"
                        ...
                        <polygon className="st7" points="180.3,262.3 180.6,253 178.1,250.8 140.4,250.8 138.1,253 138.3,262.3 106.8,247.4 117.8,256.4   140.1,271.9 178.4,271.9 200.8,256.4 211.8,247.4 " />
