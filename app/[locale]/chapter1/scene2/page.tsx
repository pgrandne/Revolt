    ...
    <div className="flex flex-row">
      ...
      <div className="relative basis-2/3 w-full overflow-hidden">
        <Sequence
          ...
          setTelegramWindow={setTelegramWindow}
      ...
      <div className="basis-1/3 p-6 h-screen flex-grow-0">
        {discussionWindow && <Discussion stage={stage} setStage={setStage} />}
        {telegramWindow && <Telegram stage={stage} setStage={setStage} />}
      </div>
